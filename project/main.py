...
class MyWindow(QMainWindow, Ui_MainWindow):
    ...
    def f_fill_questions(self):
        questions_and_answers = [
            ...
            (
                "Как лучше путешествовать по Европе?",
                "Используйте поезда (Eurail или Interrail), бюджетные авиалинии и автобусные компании, такие как FlixBus."
            ),
            (
                "Как избежать туристических мошенников?",
                "Не показывайте ценные вещи, проверяйте лицензию гидов и избегайте подозрительных предложений."
            ),
            (
            ...
            (
                "Что делать, если пропущен рейс?",
                "Свяжитесь с авиакомпанией, чтобы перенести рейс, или обратитесь за компенсацией, если это не ваша вина."
            ),
            (
                "Как избежать перевеса багажа?",
                "Используйте ручные весы для багажа и распределяйте вещи между ручной кладью и основным багажом."
            ),
            (
                "Где лучше питаться за границей?",
                "Ищите рестораны с хорошими отзывами на Google Maps или Tripadvisor и пробуйте местные рынки."
            ),
            (
